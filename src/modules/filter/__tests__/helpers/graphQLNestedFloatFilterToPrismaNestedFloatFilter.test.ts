import { NestedFloatFilter as GraphQLNestedFloatFilter } from '@jest-games-organization/backend-package-graphql-types';
import { graphQLNestedFloatFilterToPrismaNestedFloatFilter } from '../../helpers/graphQLNestedFloatFilterToPrismaNestedFloatFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedFloatFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLNestedFloatFilterToPrismaNestedFloatFilter(filter);
