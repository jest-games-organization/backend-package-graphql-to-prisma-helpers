...
import { mapGraphQLFilterByFloatNestedToPrismaNestedFloatNullableFilter } from '../../helpers/mapGraphQLFilterByFloatNestedToPrismaNestedFloatNullableFilter';

describe('GIVEN the mapGraphQLFilterByFloatNestedToPrismaNestedFloatNullableFilter method', () => {
  let filter: FilterByFloatNested | null | undefined;

  describe('WHEN the filter by float nested is null', () => {
    beforeEach(() => {
      filter = null;
    });

    test('THEN it should return undefined', () => {
      const response = mapGraphQLFilterByFloatNestedToPrismaNestedFloatNullableFilter(filter);
      expect(response).toBeUndefined();
    });
  });

  describe('WHEN the filter by float nested is undefined', () => {
    beforeEach(() => {
      filter = undefined;
    });
  ...
  describe('WHEN the filter by float nested is defined', () => {
