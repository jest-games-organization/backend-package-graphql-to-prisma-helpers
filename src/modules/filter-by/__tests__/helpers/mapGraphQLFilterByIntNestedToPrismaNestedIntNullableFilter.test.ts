...
import { mapGraphQLFilterByIntNestedToPrismaNestedIntNullableFilter } from '../../helpers/mapGraphQLFilterByIntNestedToPrismaNestedIntNullableFilter';

describe('GIVEN the mapGraphQLFilterByIntNestedToPrismaNestedIntNullableFilter method', () => {
  let filter: FilterByIntNested | null | undefined;

  describe('WHEN the filter by int nested is null', () => {
    beforeEach(() => {
      filter = null;
    });

    test('THEN it should return undefined', () => {
      const response = mapGraphQLFilterByIntNestedToPrismaNestedIntNullableFilter(filter);
      expect(response).toBeUndefined();
    });
  });

  describe('WHEN the filter by int nested is undefined', () => {
    beforeEach(() => {
      filter = undefined;
    });
  ...
  describe('WHEN the filter by int nested is defined', () => {
