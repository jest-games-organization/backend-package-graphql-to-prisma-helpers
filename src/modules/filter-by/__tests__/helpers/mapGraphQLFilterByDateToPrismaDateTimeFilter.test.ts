...
import { mapGraphQLFilterByDateToPrismaDateTimeFilter } from '../../helpers/mapGraphQLFilterByDateToPrismaDateTimeFilter';

describe('GIVEN the mapGraphQLFilterByDateToPrismaDateTimeFilter', () => {
  ...
  describe('AND the equals property', () => {
    describe('WHEN the equals property is undefined', () => {
      ...
      test('THEN it should return the prisma date time filter', () => {
        const response = mapGraphQLFilterByDateToPrismaDateTimeFilter(graphQLFilterByDate);
