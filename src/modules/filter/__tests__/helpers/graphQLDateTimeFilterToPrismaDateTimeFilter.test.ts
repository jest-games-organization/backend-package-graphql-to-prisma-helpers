...
import { graphQLDateTimeFilterToPrismaDateTimeFilter } from '../../helpers/graphQLDateTimeFilterToPrismaDateTimeFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLDateTimeFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLDateTimeFilterToPrismaDateTimeFilter(filter);
