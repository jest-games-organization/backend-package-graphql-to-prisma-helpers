...
import { graphQLDateTimeNullableFilterToPrismaDateTimeNullableFilter } from '../../helpers/graphQLDateTimeNullableFilterToPrismaDateTimeNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLDateTimeNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLDateTimeNullableFilterToPrismaDateTimeNullableFilter(filter);
