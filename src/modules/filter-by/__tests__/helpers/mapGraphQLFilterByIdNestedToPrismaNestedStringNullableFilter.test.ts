...
import { mapGraphQLFilterByIdNestedToPrismaNestedStringNullableFilter } from '../../helpers/mapGraphQLFilterByIdNestedToPrismaNestedStringNullableFilter';

describe('GIVEN the mapGraphQLFilterByIdNestedToPrismaNestedStringNullableFilter method', () => {
  ...
  describe('WHEN the filter by id nested is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const result = mapGraphQLFilterByIdNestedToPrismaNestedStringNullableFilter(filter);
    ...
    describe('AND the equals property', () => {
      describe('WHEN the equals property is undefined', () => {
        ...
        test('THEN it should return the prisma nested string filter', () => {
          const response = mapGraphQLFilterByIdNestedToPrismaNestedStringNullableFilter(filter);
