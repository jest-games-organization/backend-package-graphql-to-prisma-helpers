import {
  IdFilter as GraphQLIdFilter,
  QueryMode as GraphQLFilterMode,
} from '@jest-games-organization/backend-package-graphql-types';
import { graphQLIdFilterToPrismaStringFilter } from '../../helpers/graphQLIdFilterToPrismaStringFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLIdFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLIdFilterToPrismaStringFilter(filter);
  ...
  describe('WHEN the filter is defined', () => {
    ...
    describe('AND the mode property', () => {
      ...
      describe('WHEN the mode property is set to default', () => {
        beforeEach(() => {
          filter = {
            mode: GraphQLFilterMode.Default,
          };
        });
      ...
      describe('WHEN the mode property is set to insensitive', () => {
        beforeEach(() => {
          filter = {
            mode: GraphQLFilterMode.Insensitive,
          };
        });
