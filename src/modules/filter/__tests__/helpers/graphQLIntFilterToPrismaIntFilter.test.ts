...
import { graphQLIntFilterToPrismaIntFilter } from '../../helpers/graphQLIntFilterToPrismaIntFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLIntFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLIntFilterToPrismaIntFilter(filter);
