...
import { mapGraphQLFilterByStringNestedToPrismaNestedStringFilter } from '../../helpers/mapGraphQLFilterByStringNestedToPrismaNestedStringFilter';

describe('GIVEN the mapGraphQLFilterByStringNestedToPrismaNestedStringFilter method', () => {
  let filter: FilterByStringNested | null | undefined;

  describe('WHEN the filter by string nested is null', () => {
    beforeEach(() => {
      filter = null;
    });

    it('THEN it should return undefined', () => {
      const response = mapGraphQLFilterByStringNestedToPrismaNestedStringFilter(filter);
      expect(response).toBeUndefined();
    });
  });

  describe('WHEN the filter by string nested is undefined', () => {
    beforeEach(() => {
      filter = undefined;
    });
  ...
  describe('WHEN the filter by string nested is defined', () => {
