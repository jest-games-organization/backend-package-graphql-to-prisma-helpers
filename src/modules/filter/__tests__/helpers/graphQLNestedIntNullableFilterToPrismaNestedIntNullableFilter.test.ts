...
import { graphQLNestedIntNullableFilterToPrismaNestedIntNullableFilter } from '../../helpers/graphQLNestedIntNullableFilterToPrismaNestedIntNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedIntNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLNestedIntNullableFilterToPrismaNestedIntNullableFilter(filter);
