...
import { mapGraphQLFilterByIntToPrismaIntFilter } from '../../helpers/mapGraphQLFilterByIntToPrismaIntFilter';

describe('GIVEN the mapGraphQLFilterByIntToPrismaIntFilter method', () => {
  let filter: FilterByInt | null | undefined;

  describe('WHEN the filter by int is null', () => {
    beforeEach(() => {
      filter = null;
    });

    test('THEN it should return undefined', () => {
      const response = mapGraphQLFilterByIntToPrismaIntFilter(filter);
      expect(response).toBeUndefined();
    });
  });

  describe('WHEN the filter by int is undefined', () => {
    beforeEach(() => {
      filter = undefined;
    });
  ...
  describe('WHEN the filter by int is defined', () => {
