...
import { mapGraphQLFilterByFloatToPrismaFloatFilter } from '../../helpers/mapGraphQLFilterByFloatToPrismaFloatFilter';

describe('GIVEN the mapGraphQLFilterByFloatToPrismaFloatFilter method', () => {
  let filter: FilterByFloat | null | undefined;

  describe('WHEN the filter by float is null', () => {
    beforeEach(() => {
      filter = null;
    });

    test('THEN it should return undefined', () => {
      const response = mapGraphQLFilterByFloatToPrismaFloatFilter(filter);
      expect(response).toBeUndefined();
    });
  });

  describe('WHEN the filter by float is undefined', () => {
    beforeEach(() => {
      filter = undefined;
    });
  ...
  describe('WHEN the filter by float is defined', () => {
