...
describe('GIVEN the mapGraphQLFilterByDateNestedToPrismaNestedDateTimeFilter method', () => {
  ...
  describe('WHEN the filter by date nested is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = mapGraphQLFilterByDateNestedToPrismaNestedDateTimeFilter(filter);
