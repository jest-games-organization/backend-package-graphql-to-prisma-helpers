...
import { graphQLIntNullableFilterToPrismaIntNullableFilter } from '../../helpers/graphQLIntNullableFilterToPrismaIntNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLIntNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    it('SHOULD return undefined', () => {
      const response = graphQLIntNullableFilterToPrismaIntNullableFilter(filter);
