...
import { graphQLFloatFilterToPrismaFloatFilter } from '../../helpers/graphQLFloatFilterToPrismaFloatFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLFloatFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLFloatFilterToPrismaFloatFilter(filter);
