import { NestedFloatNullableFilter as GraphQLNestedFloatNullableFilter } from '@jest-games-organization/backend-package-graphql-types';
import { graphQLNestedFloatNullableFilterToPrismaNestedFloatNullableFilter } from '../../helpers/graphQLNestedFloatNullableFilterToPrismaNestedFloatNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedFloatNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLNestedFloatNullableFilterToPrismaNestedFloatNullableFilter(filter);
