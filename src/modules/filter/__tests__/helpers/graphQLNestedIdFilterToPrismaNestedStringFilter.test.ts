import { NestedIdFilter as GraphQLNestedIdFilter } from '@jest-games-organization/backend-package-graphql-types';
import { graphQLNestedIdFilterToPrismaNestedStringFilter } from '../../helpers/graphQLNestedIdFilterToPrismaNestedStringFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedIdFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLNestedIdFilterToPrismaNestedStringFilter(filter);
