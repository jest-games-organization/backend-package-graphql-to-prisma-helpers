...
import { graphQLNestedStringFilterToPrismaNestedStringFilter } from '../../helpers/graphQLNestedStringFilterToPrismaNestedStringFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedStringFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    it('THEN it should return undefined', () => {
      const response = graphQLNestedStringFilterToPrismaNestedStringFilter(filter);
