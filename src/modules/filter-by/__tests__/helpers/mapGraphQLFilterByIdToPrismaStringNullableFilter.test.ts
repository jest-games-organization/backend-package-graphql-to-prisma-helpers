...
import { mapGraphQLFilterByIdToPrismaStringNullableFilter } from '../../helpers/mapGraphQLFilterByIdToPrismaStringNullableFilter';

describe('GIVEN the mapGraphQLFilterByIdToPrismaStringNullableFilter method', () => {
  let filter: FilterById | null | undefined;

  describe('WHEN the filter by id is null', () => {
    beforeEach(() => {
      filter = null;
    });

    test('THEN it should return undefined', () => {
      const response = mapGraphQLFilterByIdToPrismaStringNullableFilter(filter);
      expect(response).toBeUndefined();
    });
  });

  describe('WHEN the filter by id is undefined', () => {
    beforeEach(() => {
      filter = undefined;
    });
  ...
  describe('WHEN the filter by id is defined', () => {
