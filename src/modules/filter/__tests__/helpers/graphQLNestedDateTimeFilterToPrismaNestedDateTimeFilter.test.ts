...
import { graphQLNestedDateTimeFilterToPrismaNestedDateTimeFilter } from '../../helpers/graphQLNestedDateTimeFilterToPrismaNestedDateTimeFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedDateTimeFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLNestedDateTimeFilterToPrismaNestedDateTimeFilter(filter);
