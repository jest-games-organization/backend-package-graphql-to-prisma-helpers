import {
  ...
  StringFilter as GraphQLStringFilter,
} from '@jest-games-organization/backend-package-graphql-types';
import { graphQLStringFilterToPrismaStringFilter } from '../../helpers/graphQLStringFilterToPrismaStringFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLStringFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLStringFilterToPrismaStringFilter(filter);
