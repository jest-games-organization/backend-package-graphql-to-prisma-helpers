...
import { graphQLFloatNullableFilterToPrismaFloatNullableFilter } from '../../helpers/graphQLFloatNullableFilterToPrismaFloatNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLFloatNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLFloatNullableFilterToPrismaFloatNullableFilter(filter);
