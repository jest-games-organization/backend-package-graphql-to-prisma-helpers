...
import { mapGraphQLFilterByDateNestedToPrismaNestedDateTimeNullableFilter } from '../../helpers/mapGraphQLFilterByDateNestedToPrismaNestedDateTimeNullableFilter';

describe('GIVEN the mapGraphQLFilterByDateNestedToPrismaNestedDateTimeNullableFilter method', () => {
  let filter: FilterByDateNested | null | undefined;

  describe('WHEN the filter by date nested is null', () => {
    beforeEach(() => {
      filter = null;
    });

    test('THEN it should return undefined', () => {
      const response = mapGraphQLFilterByDateNestedToPrismaNestedDateTimeNullableFilter(filter);
      expect(response).toBeUndefined();
    });
  });

  describe('WHEN the filter by date nested is undefined', () => {
    beforeEach(() => {
      filter = undefined;
    });
  ...
  describe('WHEN the filter by date nested is defined', () => {
