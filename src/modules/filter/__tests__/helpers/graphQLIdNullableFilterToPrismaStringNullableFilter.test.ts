import {
  IdNullableFilter as GraphQLIdNullableFilter,
  QueryMode as GraphQLQueryMode,
} from '@jest-games-organization/backend-package-graphql-types';
import { graphQLIdNullableFilterToPrismaStringNullableFilter } from '../../helpers/graphQLIdNullableFilterToPrismaStringNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLIdNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLIdNullableFilterToPrismaStringNullableFilter(filter);
