...
import { mapGraphQLFilterByStringToPrismaStringNullableFilter } from '../../helpers/mapGraphQLFilterByStringToPrismaStringNullableFilter';

describe('GIVEN the mapGraphQLFilterByStringToPrismaStringNullableFilter method', () => {
  let filter: FilterByString | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const result = mapGraphQLFilterByStringToPrismaStringNullableFilter(filter);
    ...
    describe('AND the equals property', () => {
      describe('WHEN the equals property is undefined', () => {
        ...
        test('THEN it should return the prisma string filter', () => {
          const response = mapGraphQLFilterByStringToPrismaStringNullableFilter(filter);
