...
describe('GIVEN the mapGraphQLFilterByDateNestedToPrismaNestedDateTimeNullableFilter', () => {
  ...
  describe('AND the equals property', () => {
    describe('WHEN the equals property is undefined', () => {
      ...
      test('THEN it should return the prisma nested date time filter', () => {
        const response = mapGraphQLFilterByDateNestedToPrismaNestedDateTimeNullableFilter(graphQLFilterByDateNested);
