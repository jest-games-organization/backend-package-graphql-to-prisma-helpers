...
import { graphQLNestedStringNullableFilterToPrismaNestedStringNullableFilter } from '../../helpers/graphQLNestedStringNullableFilterToPrismaNestedStringNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedStringNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    it('THEN it should return undefined', () => {
      const response = graphQLNestedStringNullableFilterToPrismaNestedStringNullableFilter(filter);
