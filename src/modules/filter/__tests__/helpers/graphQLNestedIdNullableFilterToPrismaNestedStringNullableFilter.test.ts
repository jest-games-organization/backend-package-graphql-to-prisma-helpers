import { NestedIdNullableFilter as GraphQLNestedIdNullableFilter } from '@jest-games-organization/backend-package-graphql-types';
import { graphQLNestedIdNullableFilterToPrismaNestedStringNullableFilter } from '../../helpers/graphQLNestedIdNullableFilterToPrismaNestedStringNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedIdNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const result = graphQLNestedIdNullableFilterToPrismaNestedStringNullableFilter(filter);
    ...
    describe('AND the equals property', () => {
      describe('WHEN the equals property is undefined', () => {
        ...
        test('THEN it should return the prisma nested string filter', () => {
          const response = graphQLNestedIdNullableFilterToPrismaNestedStringNullableFilter(filter);
