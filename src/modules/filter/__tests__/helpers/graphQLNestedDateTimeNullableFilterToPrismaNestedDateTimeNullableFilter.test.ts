...
import { graphQLNestedDateTimeNullableFilterToPrismaNestedDateTimeNullableFilter } from '../../helpers/graphQLNestedDateTimeNullableFilterToPrismaNestedDateTimeNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLNestedDateTimeNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const response = graphQLNestedDateTimeNullableFilterToPrismaNestedDateTimeNullableFilter(filter);
