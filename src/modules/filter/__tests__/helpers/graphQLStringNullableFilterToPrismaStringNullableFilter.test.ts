import {
  QueryMode as GraphQLQueryMode,
  StringNullableFilter as GraphQLStringNullableFilter,
} from '@jest-games-organization/backend-package-graphql-types';
import { graphQLStringNullableFilterToPrismaStringNullableFilter } from '../../helpers/graphQLStringNullableFilterToPrismaStringNullableFilter';

describe('GIVEN the method', () => {
  let filter: GraphQLStringNullableFilter | null | undefined;
  ...
  describe('WHEN the filter is null', () => {
    ...
    test('THEN it should return undefined', () => {
      const result = graphQLStringNullableFilterToPrismaStringNullableFilter(filter);
  ...
  describe('WHEN the filter is defined', () => {
    describe('AND the equals property', () => {
      describe('WHEN the equals property is undefined', () => {
        ...
        test('THEN it should return the prisma string filter', () => {
          const response = graphQLStringNullableFilterToPrismaStringNullableFilter(filter);
    ...
    describe('AND the mode property', () => {
      ...
      describe('WHEN the mode property is set to insensitive', () => {
        beforeEach(() => {
          filter = {
            mode: GraphQLQueryMode.Insensitive,
          };
        });
